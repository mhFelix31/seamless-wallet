...
class WalletTransactionSnapshot(Base):
    ...
    snapshot_start_datetime: Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
    snapshot_end_datetime:  Mapped[datetime] = mapped_column(DateTime(timezone=True), nullable=False)
