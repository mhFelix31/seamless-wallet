...
from src.api.dependencies import check_db, check_cache, get_cache_client, get_cache_type, get_db_engine, get_db_type
...
@router.get("/cache")
async def cache_check(cache_client = Depends(get_cache_client), cache_type = Depends(get_cache_type)):
